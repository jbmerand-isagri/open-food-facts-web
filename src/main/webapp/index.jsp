...
<body class="bg-light">
	...
	<main class="p-5">
		...
		<div class="text-center">
			<a href="http://localhost:8080/off-web/rechercher" role="button" class="btn btn-dark p-3 w-75 m-3">Rechercher des produits</a>
		</div>

		<div class="text-center">
			<a href="http://localhost:8080/off-web/ajouter" role="button" class="btn btn-dark p-3 w-75 m-3">Ajouter un produit</a>
		</div>
